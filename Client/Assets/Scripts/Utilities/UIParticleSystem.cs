...
namespace UnityEngine.UI.Extensions.CasualGame
{
    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        [SerializeField]
        private string MaintextureName = "_Maintexture";
        ...
        protected bool Initialize()
        {
            ...
            if (pSystem == null)
            {
                ...
                if (currentMaterial && currentMaterial.HasProperty(MaintextureName))
                {
                    currentTexture = currentMaterial.GetTexture(MaintextureName);
        ...
        private void Update()
        {
            if (!fixedTime && Application.isPlaying)
            {
                ...
                if ((currentMaterial != null && currentTexture != currentMaterial.GetTexture(MaintextureName)) ||
